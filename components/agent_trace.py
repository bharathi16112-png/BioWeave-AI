...
def render_agent_trace(profile_data):
    """Renders the agent execution trace timeline using st.html() for reliable HTML rendering."""
    ...
    for idx, trace in enumerate(traces):
        ...
        # Determine dot style: last completed step glows
        if status == "completed" and is_last:
            ...
            dot_style = "background-color: #0E1117;"

        # Bottom border on all but last step
        step_border = "border-bottom: 1px solid rgba(255,255,255,0.04); margin-bottom: 0;" if not is_last else ""
        ...
        ">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 7px;">
                <div style="display: flex; align-items: center; gap: 8px;">
                    <span style="font-family: 'Outfit', sans-serif; font-weight: 700; color: #00D2D3; font-size: 1.05rem;">
                        {agent_name}
                    </span>
                    <span style="
                ...
                <div style="font-family: 'Space Mono', monospace; font-size: 0.78rem; color: #707070; white-space: nowrap;">
                    <span style="color: #505050;">Duration:</span>
                    <span style="color: #00D2D3; font-weight: bold;"> {duration} ms</span>
                    &nbsp;&bull;&nbsp;
                    <span style="color: {status_color}; font-weight: bold; text-transform: uppercase; font-size: 0.72rem; letter-spacing: 0.5px;">
                        {status}
                    </span>
                </div>
            </div>
